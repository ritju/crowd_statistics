...
from crowd_statistics.nanodet.util import bbox2distance, distance2bbox, multi_apply, overlay_bbox_cv
...
class NanoDetPlusHead(nn.Module):
    ...
    def show_result(
        ...
        result_img,all_box = overlay_bbox_cv(img, dets, class_names, score_thresh=score_thres)
        if show:
